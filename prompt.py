...
#   M12 Event Mandate             — Unit 사건 발생 강제 + 회상 30% 제한
#   M13 Paragraph Rhythm          — 문단·대사 리듬 (작가 원고 12만자 실측 기반)
...
★ 절대 규칙 3 — 대사 밀도 ★
- ★만자당 대사 70개 이상★ (작가 실측: 시크릿퀸 78개 / 감각구역 141개)
- 엔진 생성분은 만자당 42개로 절반 수준이었다. 대사가 적으면 서술이 팽창하고,
  사건 대신 묘사가 지면을 차지한다.
...
NOVEL_ENGINE_VERSION = "v3.10.0"
NOVEL_ENGINE_BUILD_DATE = "2026-07-24"
NOVEL_ENGINE_VERSION_TAG = "v3.10.0 / 2026-07-24 / Composite Genre Operating Principle (author corpus)"
