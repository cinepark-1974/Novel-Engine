...
A-1. 종결어미 반복 금지
  ...
  - GOOD: 종결어미를 섞어라. "~였다. ~았다. ~했다. ~이다." / "~이었다" 뒤에 "~ㄴ 것이다" 또는 명사형 종결("~인 셈.") 또는 문장을 합쳐 중간에 쉼표로 이어라.
  - 특히 "~이었다"가 연속 3회 이상 나오면 반드시 구조를 바꿔라.

A-2. 주어 반복 금지
  - BAD: "유진은 ~했다. 유진은 ~했다. 그녀는 ~했다. 그녀는 ~했다."
  - GOOD: 주어를 생략하거나, 사물/환경을 주어로 바꿔라.
  - "유진은 잔을 내려놓았다. 와인이 잔 안에서 흔들렸다. 창밖으로 눈을 돌렸다." — 3문장에 주어가 3번 다르다.

A-3. 구문 구조 반복 금지
  - BAD: "그녀는 A를 했다. 그녀는 B를 했다. 그녀는 C를 했다." (주어+목적어+서술어 반복)
  - GOOD: 구문 구조를 섞어라. 주어+서술어, 목적어 도치, 부사구로 시작, 감각 묘사로 시작, 짧은 명사구 — 연속 3문장이 같은 구조이면 안 된다.

A-4. 설명문 리듬 금지
  - BAD: "그것은 ~이었다. 그리고 ~이었다. 또한 ~이었다." (정보 나열 구조)
  - GOOD: 정보를 나열하지 마라. 정보는 행동, 대사, 감각 속에 1개씩 심어라.
